# Configuring Azure Information Protection Labels and Policies
...
Microsoft 365 E5 Tenant credentials will be provided for the lab.
...
In this lab, we will primarily discuss the second and third phases (Classify and label, and Protect and control sharing), but we will also touch on Discovery using Recommended and Automatic conditions.  Additional Discovery topics and Monitoring will be covered in other labs in this series.

Please click **Next** below to begin the lab.
